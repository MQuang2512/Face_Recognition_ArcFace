...
def distance2bbox(points, distance, max_shape=None, padding_ratio=0.1):
    """Decode distance prediction to bounding box with padding.
    ...
    Args:
        ...
        padding_ratio (float): Ratio to expand the bbox, default 0.1 (10%).
    ...
    # Apply padding
    padding_w = width * padding_ratio
    padding_h = height * padding_ratio
